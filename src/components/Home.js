    ...
    if (isLoading) {
        ...
        return (
            <>
                ...
                {jwtToken === "" &&
                    <div className="row justify-content-center" style={{ backgroundColor: "#d2d6db" }}>
                        <div className="" style={{ backgroundColor: "#d2d6db", width: 'fit-content' }}>
                            <div className='mt-2 px-5 py-5 row justify-content-center'>
                                <h1 className="text-center" style={{ fontSize: 40, fontWeight: 600, fontFamily: "revert", color: "#061868", fontFamily: 'Gill Sans' }}>Streamline Invoicing</h1>
                                <h5 className='text-center mt-5 px-5 me-5 ms-5' style={{ color: "#061868", fontFamily: 'Gill Sans' }}>
